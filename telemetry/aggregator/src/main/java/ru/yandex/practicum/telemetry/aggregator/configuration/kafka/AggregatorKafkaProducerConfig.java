...
/**
 * Конфигурационный класс для настройки Kafka-продюсера в агрегаторе телеметрии.
 * <p>
 * Этот класс предоставляет бин {@link KafkaProducer}, настроенный на отправку сообщений
 * типа {@link SensorsSnapshotAvro}. Он получает свойства продюсера из конфигурации
 * приложения.
 */
@Getter
@Setter
