...
/**
 * Конфигурационный класс для настройки Kafka-консьюмера в агрегаторе телеметрии.
 * <p>
 * Этот класс предоставляет бин {@link KafkaConsumer}, настроенный на получение сообщений
 * типа {@link SensorEventAvro}. Он получает свойства Kafka-консьюмера из конфигурации
 * приложения.
 * </p>
 * Предоставляет настройки для ручного управления оффсетами: {@code ENABLE_AUTO_COMMIT_CONFIG}
 * установлено в {@code false}
 */
@Getter
@Setter
