...
public class SnapshotServiceImpl implements SnapshotService {
    ...
    /**
     * Обновляет состояние снимка сенсора на основе переданного события сенсора.
     * <p>
     * Этот метод выполняет следующие операции:
     * <ol>
     *   <li>
     *     Пытается найти существующий снимок для хаба, связанного с событием.
     *     Если ничего не найдено — создаётся новый снимок.
     *   </li>
     *   <li>
     *     Проверяет, содержит ли снимок данные о состоянии сенсора с ID события.
     *     Если текущие данные более свежие или идентичные, обновление пропускается,
     *     и возвращается {@code Optional.empty()}.
     *   </li>
     *   <li>
     *     Если данные необходимо обновить, создаётся новое состояние сенсора,
     *     которое добавляется в снимок. Таймстемп снимка обновляется в соответствии
     *     с таймстемпом события.
     *   </li>
     *   <li>
     *     Обновлённый снимок сохраняется в репозиторий
     *     и возвращается в виде {@code Optional}.
     *   </li>
     * </ol>
     *
     * @param event входящее событие сенсора
     * @return {@code Optional}, содержащий обновлённый снимок, или пустой, если обновление не требовалось.
     *
     */
    @Override
