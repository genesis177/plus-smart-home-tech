...
/**
 * {@code AggregationStarter} отвечает за запуск и управление процессом агрегирования данных,
 * потребляя события из Kafka-топиков, обрабатывая данные показаний сенсоров и отправляя
 * обратно в Kafka снимки состояния сенсоров, связанных с определённым хабом.
 */
@Component
