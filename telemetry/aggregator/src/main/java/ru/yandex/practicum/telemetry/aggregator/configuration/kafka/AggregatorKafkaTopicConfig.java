...
/**
 * Конфигурационный класс для управления Kafka-топиками в агрегаторе телеметрии.
 * <p>
 * Этот класс предоставляет бины для продюсерских и консьюмерских топиков, гарантируя,
 * что они корректно внедряются из конфигурации приложения.
 */
@Getter
@Setter
