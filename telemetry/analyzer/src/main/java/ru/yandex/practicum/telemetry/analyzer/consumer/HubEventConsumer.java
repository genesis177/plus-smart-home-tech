...
/**
 * Класс {@code HubEventConsumer} прослушивает темы Kafka, связанные с событиями хаба, и обрабатывает
 * сообщения, касающиеся добавления, удаления устройств и обновления сценариев.
 *
 * <p>Он работает в отдельном потоке и непрерывно опрашивает Kafka на наличие новых сообщений.
 * Когда сообщения получены, они направляются для дальнейшей обработки.
 *
 * <p>Ключевые обязанности:
 * <ul>
 * <li>Подписка на темы Kafka, содержащие события, связанные с хабом.</li>
 * <li>Опрос новых сообщений и их соответствующая обработка.</li>
 * <li>Фиксация смещений (offsets) для отслеживания обработанных сообщений.</li>
