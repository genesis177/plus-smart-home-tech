...
/**
 * Класс конфигурации, который управляет настройками Kafka из свойств приложения, включая bootstrap-серверы, темы и настройки продюсера.
 * <p>
 * Этот класс отвечает за конфигурирование Kafka-продюсера и получение названий тем на основе перечислений тем.
 */
