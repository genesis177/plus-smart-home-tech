...
/**
 * Класс конфигурации, управляющий настройками Kafka из конфигурационного файла приложения, включая адреса bootstrap-серверов, топики и параметры продюсера.
 * <p>
 * Этот класс отвечает за настройку продюсера Kafka и получение названий топиков на основе перечислений (enum) топиков.
 */
