...
/**
 * {@link KafkaEventProducer} отвечает за формирование и отправку сообщений в тему Kafka.
 * <p>
 * Он использует Kafka {@link Producer} для публикации сообщений в формате Avro и обеспечивает
 * корректное управление ресурсами, закрывая продюсер при завершении работы приложения.
 */
