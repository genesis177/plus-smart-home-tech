...
/**
 * Глобальный обработчик исключений API, отвечающий за перехват любых необработанных {@link Exception} и
 * преобразование их в стандартизированные JSON-ответы {@link ErrorResponse}.
 */
